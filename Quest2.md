...
- 수행 결과 : 가독성을 위주로 개선하기를 두번 진행했습니다.

- 소감 : 개선하기 시간을 이용해서 코드의 가독성을 높이려고 노력했습니다. 항상 미션 요구사항을 구현하기에 급급했기 때문에 개선 시간에는 코드 가독성을 높이는 것에 집중했습니다.
...
- 소감 : 맛있는 음식들로 에너지를 채워, 3주차를 든든하게 보낼 수 있었습니다!! 역시 맛있는 음식은 최고의 에니지원✌
